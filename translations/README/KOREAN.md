...
> :sparkling_heart: 으로 제작된 로고, 제작자: [CandidDeer](https://github.com/Unity-Billal-mesloub)
...
1. GitHub 계정에 로그인하세요. 만약 아직 계정이 없으시다면 [GitHub에 가입하세요](https://github.com/Unity-Billal-mesloub). 원활한 작업 진행을 위해 [GitHub Hello World 튜토리얼](https://guides.github.com/activities/hello-world/)을 읽고 시작하는 것을 추천드립니다.
...
- 자신이 저장소의 [메인 페이지](https://github.com/Unity-Billal-mesloub/Contribute-To-This-Project 'https://github.com/Unity-Billal-mesloub/Contribute-To-This-Project')에 있는지 확인하세요.
...
- 연락을 원하시면 **저를 팔로우**해주세요,
- (https://syknapse.github.io/Syk-Houdeib/#contact 'My contact section | Portfolio')
...
이 프로젝트는 [Roshan Jossey](https://github.com/Unity-Educational-Formation)가 만든 최고의 [first-contributions](https://github.com/Unity-Educational-Formation/first-contributions) 프로젝트에서 많은 영향을 받았습니다.
